                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg border">
                    ...
                    {isUploadingVideo ? (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-accent-600">{videoUploadProgress}%</span>
                      </div>
                    ) : (
                      <button
                        type="button"
                ...
                {createQuiz && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <button
                        onClick={addQuestion}
                        className="w-full flex items-center justify-center gap-2 px-4 py-2 border-2 border-dashed rounded-lg text-gray-500 hover:border-accent-600 hover:text-accent-600"
                      >
