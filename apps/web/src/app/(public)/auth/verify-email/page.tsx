          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center">
            ...
            <div className="space-y-3">
              <Link href="/auth/register">
                <button className="w-full flex items-center justify-center px-4 py-3 border-2 border-accent-600 text-base font-medium rounded-xl text-accent-600 bg-white hover:bg-primary-50 transition-all duration-200">
