...
import { ArrowLeft, Save, Trash2, ChevronDown, ChevronUp, HelpCircle, Plus } from 'lucide-react';
...
export default function ChapterEditPage() {
  ...
  const { data: chapterData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      // We'll need to add this endpoint or fetch from chapters list
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (includeQuiz && questions.length > 0) {
        ...
        toast.success('თავი და ქვიზი განახლდა!');
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">თავის რედაქტირება</h1>
