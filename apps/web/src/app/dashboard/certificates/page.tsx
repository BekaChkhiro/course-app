        ...
        <div className="flex gap-2">
          {certificate.pdfUrl && (
            <a
              ...
              download
              className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-accent-600 text-white rounded-lg hover:bg-accent-700 transition-colors text-sm font-medium"
            >
