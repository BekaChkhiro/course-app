        ...
        <div className="flex-shrink-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              {unreadCount > 0 ? `${unreadCount} unread message${unreadCount !== 1 ? 's' : ''}` : 'Contact support'}
            </p>
          </div>
          <button
            onClick={() => {
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Our support team typically responds within 24 hours. For urgent issues, please mark your message as "Urgent" priority.
              </p>
            </div>
          </div>
        </div>
