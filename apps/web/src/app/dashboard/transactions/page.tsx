    ...
    <div className="bg-white border-b border-gray-100 p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="flex items-center gap-2">
              {transaction.discount ? (
                <>
                  <span className="text-xs text-gray-400 line-through">{formatCurrency(transaction.originalAmount)}</span>
          ...
          {transaction.discount && (
            <span className="inline-flex items-center mt-1.5 px-1.5 py-0.5 bg-green-50 text-green-700 text-[10px] font-medium rounded-full">
